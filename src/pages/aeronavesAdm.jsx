        ...
        <div className="h-full w-ful py-29 px-18">
            <div className="flex flex-col gap-6 h-full w-full">
                <div className="flex flex-row gap-6">
                    <button onClick={() => {navigate(-1)}} className="bg-slate-400 p-2 w-12 cursor-pointer shadow-md hover:bg-slate-300 transition">
                ...
                <div className="grid grid-cols-2 gap-y-7 gap-x-20 pb-7">
                    ...
                    <div className="flex justify-between place-items-center pb-6">
                        ...
                        <button onClick={() => {navigate(`/etapas`)}} className="mt-4 px-6 py-2 bg-blue-600 text-white rounded-xl shadow-md hover:bg-blue-500 transition">ADICIONAR</button>
                    </div>
                    <div className="w-full rounded-lg overflow-hidden flex flex-col gap-2">
